...
public class EnemyAI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Naya Logic: Jaise hi player Cutscene Range mein aayega, Deewarein ON ho jayengi
        if (distanceToPlayer <= cutsceneRange && arenaWalls != null && !arenaWalls.activeSelf)
        {
    ...
    void HandleChasing(float distance)
    {
        ...
        // 0.5f ka matlab hai Walk animation chalega (1f par Run chalta tha)
